...
- The `wiki:publish` script warns `?? none detected` if no thumbnail is found — add the image before publishing or add it to the infoBox via a targeted Supabase update after
