  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
        Verified sports and culture coverage. World Cup 2026, Premier League, MLS, MLB, supercars, and the creator economy. Accuracy over speed, primary sources only.
      </p>
      ...
      <div className="flex items-center gap-1.5 text-xs text-gray-400 mb-5">
        ...
        <a href="mailto:editorial@objectivewire.com" className="hover:text-black dark:hover:text-white transition-colors">editorial@objectivewire.com</a>
      </div>
