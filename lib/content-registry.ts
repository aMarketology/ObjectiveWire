...
export const contentRegistry: ContentEntry[] = [
  // --- Auto-added by wiki:publish 2026-04-18 ---
  {
    ...
    imageUrl: "https://www.objectivewire.org/entertainment/forza_horizon_6.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Auto-added by wiki:publish 2026-04-19 ---
  {
    ...
    priority: 0.7,
    changeFrequency: "weekly",
    imageUrl: "https://www.objectivewire.org/influncer/sdmn_charitymatch_26.webp",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Auto-added by wiki:publish 2026-04-23 ---
  {
    ...
    priority: 0.7,
    changeFrequency: "weekly",
    imageUrl: "https://www.objectivewire.org/entertainment/InsideS3.webp",
    imageWidth: 1200,
    imageHeight: 675,
