...
export const metadata: Metadata = {
  title:
    'YouTube Suspends "The Omnibus Project" for 90 Days After AI Flags 2019 Antisemitism Debunking Episode',
  description:
    "YouTube's AI hate speech filter issued a three-month suspension to Ken Jennings and John Roderick's Omnibus Project podcast, targeting a 2019 episode that",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Ken Jennings and John Roderick's podcast is suspended until June 6, 2026 after YouTube's AI flagged a 2019 episode debunking The Protocols of the Elders",
    type: 'article',
    url: ARTICLE_URL,
    siteName: 'ObjectWire',
