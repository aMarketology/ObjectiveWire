...
//   NEXTAUTH_URL             — https://www.objectivewire.com   (prod)
//                              http://localhost:3000          (local)
//
// Google Cloud Console — Authorized Redirect URIs to add:
//   https://www.objectivewire.com/api/auth/callback/google
//   http://localhost:3000/api/auth/callback/google
//
// Discord Dev Portal — OAuth2 Redirect URIs to add:
//   https://www.objectivewire.com/api/auth/callback/discord
