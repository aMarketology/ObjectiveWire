...
const PAGE_URL = 'https://www.objectivewire.com/service/investigative-reporting';
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Services', item: 'https://www.objectivewire.com/service' },
