...
const ARTICLE_URL = 'https://www.objectwire.org/creator/faithordway';
...
export default function CreatorFaithordwayPage() {
  return <CreatorArticleDB slug="creator/faithordway" />;
}
