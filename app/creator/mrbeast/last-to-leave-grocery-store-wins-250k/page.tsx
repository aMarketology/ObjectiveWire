...
export default function CreatorMrbeastLastToLeaveGroceryStoreWins250kPage() {
  return <CreatorArticleDB slug="creator-mrbeast-last-to-leave-grocery-store-wins-250k" />;
}
