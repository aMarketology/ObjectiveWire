...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/creator/mrbeast-launches-beast-games-season-2-casting',
  },
  openGraph: {
    title: "MrBeast Announces Beast Games Season 2 Casting | Everything",
    description: "MrBeast has officially opened casting for Beast Games Season 2. Here",
    type: 'article',
    url: "https://www.objectwire.org/creator/mrbeast-launches-beast-games-season-2-casting",
    siteName: 'ObjectWire',
    section: "Creator",
  },
  twitter: {
...
export default function BeastGamesSeason2CastingPage() {
  return <NewsArticleDB slug="creator-mrbeast-launches-beast-games-season-2-casting" />;
}
