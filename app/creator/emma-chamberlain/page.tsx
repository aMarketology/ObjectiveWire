...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://www.owire.org${IMAGE_URL}`, width: 1200, height: 675, alt: 'Emma Chamberlain, YouTube creator and Chamberlain Coffee founder' }],
  },
  twitter: {
...
export default function EmmaChamberlinPage() {
  return (
    <CreatorArticle
      ...
      tags={['Emma Chamberlain', 'YouTube', 'Chamberlain Coffee', 'Creator', 'Louis Vuitton', 'California']}
    >
