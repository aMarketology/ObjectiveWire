...
const ARTICLE_SCHEMA = {
  ...
  author: { '@type': 'Person', name: 'Michael Cripe', url: 'https://www.objectivewire.org/authors/michael-cripe' },
  publisher: {
    '@type': 'Organization',
    name: 'ObjectWire',
    url: 'https://www.objectivewire.org',
    logo: { '@type': 'ImageObject', url: 'https://www.objectivewire.org/logo.png' },
  },
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Copyright', item: 'https://www.objectivewire.org/copyright' },
    { '@type': 'ListItem', position: 3, name: 'News', item: 'https://www.objectivewire.org/copyright/news' },
