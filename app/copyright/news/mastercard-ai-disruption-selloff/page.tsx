...
export const metadata: Metadata = {
  title: 'Mastercard Falls Below $500 | AI Disruption Note Triggers Payments Sector Selloff 2026',
  description:
    'Mastercard (NYSE: MA) fell 5.73% on February 23, 2026, closing at $496.40, its first sub-$500 close since April 2025, after a viral research note warned that agentic AI could displace card network transaction volume by 2030.',
  keywords: [
  ...
  openGraph: {
    title: "Mastercard Falls Below $500 | AI Disruption Note Wipes $30B in Payments Sector",
    description:
...
export default function MastercardAISelloffPage() {
  return <NewsArticleDB slug="copyright-news-mastercard-ai-disruption-selloff" />;
}
