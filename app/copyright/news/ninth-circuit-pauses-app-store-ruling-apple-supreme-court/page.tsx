...
export const metadata: Metadata = {
  title: 'Ninth Circuit Pauses App Store Ruling | Apple Heads to Supreme Court Over 27% Commission',
  description: 'The Ninth Circuit granted Apple a stay on its App Store contempt ruling while the company prepares a Supreme Court petition, pausing enforcement of the external payment injunction. Epic Games calls it a delay tactic.',
  keywords: [
  ...
  openGraph: {
    title: 'Ninth Circuit Pauses App Store Ruling | Apple Petitions Supreme Court',
