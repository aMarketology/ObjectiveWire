...
export const metadata: Metadata = {
  ...
  description:
    'Documented profiles of Austin nonprofits, civic organizations, advocacy groups, and PACs of public interest. Objective Wire investigative directory.',
  keywords: [
    'Austin nonprofits directory', 'Texas civic organizations', 'Austin advocacy groups',
    'Texans for Public Justice', 'Texas Appleseed', 'Austin Chamber of Commerce',
    'Texas Civil Rights Project', 'Austin organizations public interest',
  ],
