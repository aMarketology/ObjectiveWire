...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.owire.org/mozilla-firefox',
  },
  openGraph: {
    ...
    type: "article",
    url: "https://www.owire.org/mozilla-firefox",
    images: [
      {
        url: "https://www.owire.org/images/mozilla-firefox-og.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://www.owire.org/images/mozilla-firefox-twitter.jpg"],
  },
};
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <NewsArticleSchema
        ...
        imageUrl="https://www.owire.org/images/mozilla-firefox.jpg"
        articleUrl="https://www.owire.org/mozilla-firefox"
