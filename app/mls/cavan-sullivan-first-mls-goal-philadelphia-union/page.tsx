...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    section: 'MLS',
    images: [{ url: `${SITE_CONFIG.url}/mls/cavan_sullivan.png`, width: 1200, height: 675, alt: 'Cavan Sullivan celebrating his first MLS goal for Philadelphia Union' }],
  ...
  twitter: {
    ...
    images: [`${SITE_CONFIG.url}/mls/cavan_sullivan.png`],
  },
};
  ...
  return (
    <>
      <NewsArticleSchema
        ...
        author="Alfonso"
        authorUrl={`${SITE_CONFIG.url}/authors/alfasa`}
        publishedTime="2026-05-15T10:00:00Z"
        modifiedTime="2026-05-15T10:00:00Z"
        articleUrl={ARTICLE_URL}
        imageUrl={`${SITE_CONFIG.url}/mls/cavan_sullivan.png`}
        imageWidth={1200}
        imageHeight={675}
        section="MLS"
        keywords={[
