...
const SLUG = '/creator/lean-beef-patty';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://www.objectivewire.com${IMAGE_URL}`, width: 1200, height: 675, alt: 'Lean Beef Patty portrait' }],
  },
  twitter: {
...
export default function CreatorLeanBeefPattyPage() {
  return <CreatorArticleDB slug="creator-lean-beef-patty" />;
}
