...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://www.objectivewire.com${IMAGE_URL}`, width: 1200, height: 675, alt: 'Charli D\'Amelio, TikTok creator and dancer' }],
  },
  twitter: {
    ...
    <CreatorArticle
      ...
      sidebar={{
        ...
        relatedLinks: [
          ...
          { href: '/creator/alix-earle', label: 'Alix Earle Profile' },
      ...
      tags={['Charli D\'Amelio', 'TikTok', 'Dancer', 'Creator', 'Connecticut', 'BORN DREAMER']}
    >
      ...
      <CreatorSection heading="Charli D'Amelio 2026 | Creator Profile Summary">
        ...
        <p>
          ...
          <a href="/creator" className="text-blue-600 hover:text-blue-800 underline">Creator Hub</a>, the{' '}
          <a href="/creator/alix-earle" className="text-blue-600 hover:text-blue-800 underline">Alix Earle profile</a>, and{' '}
