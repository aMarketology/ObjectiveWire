...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://www.objectivewire.com${IMAGE_URL}`, width: 1200, height: 675, alt: 'Megan Marie portrait' }],
  },
  twitter: {
...
export default function CreatorMeganMariePage() {
  return <CreatorArticleDB slug="creator-megan-marie" />;
}
