...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `https://www.objectivewire.com${IMAGE_URL}`, width: 1200, height: 675, alt: 'Valkyrae, 100 Thieves co-owner and YouTube Gaming creator' }],
  },
  twitter: {
    ...
    <CreatorArticle
      ...
      sidebar={{
        ...
        relatedLinks: [
          ...
          { href: '/creator/pokimane', label: 'Pokimane Profile' },
