...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectivewire.com/creator/news/logan-paul-sells-pokemon-card-16-million',
  },
  openGraph: {
    title: 'Logan Paul Sells 1/1 Pikachu Illustrator for $16 Million',
    description:
    ...
    type: 'article',
    url: 'https://www.objectivewire.com/creator/news/logan-paul-sells-pokemon-card-16-million',
    siteName: 'OzoneNews',
