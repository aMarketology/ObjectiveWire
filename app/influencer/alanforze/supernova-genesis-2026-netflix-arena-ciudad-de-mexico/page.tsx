...
const SLUG = '/creator/alanforze/supernova-genesis-2026-netflix-arena-ciudad-de-mexico';
...
export default function CreatorAlanforzeSupernovaGenesis2026NetflixArenaCiudadDeMexicoPage() {
  return <NewsArticleDB slug="creator-alanforze-supernova-genesis-2026-netflix-arena-ciudad-de-mexico" />;
}
