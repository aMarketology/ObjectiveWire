      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center space-y-4">
          <div className="flex justify-center">
            <div className="w-20 h-20 bg-black flex items-center justify-center rounded-lg shadow-lg">
              <span className="text-white font-bold text-3xl">OW</span>
            </div>
          </div>
          <div>
            <CardTitle className="text-3xl font-bold">Objective Wire Admin</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-center text-gray-500">
              Secure admin access • Objective Wire © {new Date().getFullYear()}
            </p>
          </div>
        </CardContent>
      </Card>
