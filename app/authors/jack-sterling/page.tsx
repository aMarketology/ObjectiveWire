...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectivewire.com/authors/jack-sterling' },
  openGraph: {
    title: 'Jack Sterling, ObjectWire Reporter',
    description: 'Reporter at ObjectWire covering Congress, federal investigations, and AI policy.',
    url: 'https://www.objectivewire.com/authors/jack-sterling',
    siteName: 'Objective Wire',
    type: 'profile',
    images: [{ url: 'https://www.objectivewire.com/influncer/author/jack_sterling.jpg', width: 800, height: 800, alt: 'Jack Sterling, ObjectWire reporter' }],
  },
  twitter: {
    card: 'summary',
    title: 'Jack Sterling, ObjectWire Reporter',
    description: 'Reporter at ObjectWire. Congress, federal investigations, AI policy.',
    images: ['https://www.objectivewire.com/influncer/author/jack_sterling.jpg'],
  },
};
