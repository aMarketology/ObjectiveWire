...
const AUTHORS = [
  ...
  },
  {
    ...
    department: 'Automotive Desk',
    location: 'Austin, TX',
    bio: 'Head of Automotive at oWire, leading hypercar, supercar, EV, and motorsport coverage. Specifications-verified, primary-source reporting on Ferrari, Bugatti, McLaren, Hennessey, and Porsche.',
    beats: ['Hypercars', 'Supercars', 'Electric Vehicles', 'Motorsport', 'Luxury Autos'],
    accent: 'bg-gray-800',
    border: 'border-gray-800',
    text: 'text-gray-800',
    quote: 'Verify the spec sheet before you publish the headline.',
  },
  {
    slug: 'carson-scott',
    initials: 'CS',
    name: 'Carson Scott',
    role: 'Chief Investigative Writer',
    department: 'Texas Investigations (.org)',
    location: 'Austin, TX',
    bio: 'Chief Investigative Writer leading the .org newsroom covering Texas public corruption, healthcare fraud, courts, and government accountability. Drives the editorial direction for investigative reporting while founders Max and Chad Black lead investigative services and operations.',
    beats: ['Texas Investigations', 'Healthcare Fraud', 'Public Corruption', 'Courts', 'Immigration Fraud', 'Pandemic Loan Fraud'],
    accent: 'bg-red-800',
    border: 'border-red-800',
    text: 'text-red-800',
    quote: 'Follow the document. It never lies when the people do.',
  },
  {
    slug: 'alfansa',
    initials: 'AL',
