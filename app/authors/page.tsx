...
const AUTHORS = [
  ...
  },
  {
    ...
    department: 'Texas Investigations',
    location: 'Austin, TX',
    bio: 'Investigative reporter leading Texas coverage of public corruption, healthcare fraud, courts, and government accountability. Also contributes MLS and MLB coverage across the Objective Wire network.',
    beats: ['Texas Investigations', 'Healthcare Fraud', 'Public Corruption', 'Courts', 'MLS', 'MLB'],
    accent: 'bg-red-800',
