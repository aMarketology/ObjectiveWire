...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectivewire.com/authors/jack-brennan' },
  openGraph: {
    title: 'Jack Brennan, ObjectWire Investigations Reporter',
    ...
    url: 'https://www.objectivewire.com/authors/jack-brennan',
    siteName: 'Objective Wire',
    type: 'profile',
    images: [{ url: 'https://www.objectivewire.com/influncer/author/jack_brennen.JPG', width: 800, height: 800, alt: 'Jack Brennan, ObjectWire investigations reporter' }],
  },
  twitter: {
    card: 'summary',
    ...
    images: ['https://www.objectivewire.com/influncer/author/jack_brennen.JPG'],
  },
};
