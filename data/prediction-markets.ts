...
export interface PredictionMarket {
  ...
  volume?: string;
  /** Optional: for resolved markets, whether this outcome actually happened. Drives the "Champion" styling. */
  resolvedOutcome?: 'won' | 'lost';
}
...
const worldCupMarkets: PredictionMarket[] = [
  {
    ...
    status: 'resolved',
    closingDate: '2026-07-19T22:00:00Z',
  ...
  },
  {
    ...
    platformUrl: 'https://kalshi.com/markets/worldcup',
    status: 'resolved',
    closingDate: '2026-07-15T22:00:00Z',
    lastUpdated: '2026-07-15T22:00:00Z',
    change24h: 0,
    volume: '$5.1M',
    resolvedOutcome: 'lost',
  },
  ...
  },
  {
    ...
    platformUrl: 'https://polymarket.com/event/2026-fifa-world-cup-winner',
    status: 'resolved',
    closingDate: '2026-07-11T22:00:00Z',
  ...
  },
  {
    ...
    platformUrl: 'https://kalshi.com/markets/worldcup',
    status: 'resolved',
    closingDate: '2026-07-04T22:00:00Z',
...
export const PREDICTION_TOPICS: PredictionTopic[] = [
  {
    ...
    description: 'Spain won the 2026 FIFA World Cup, defeating Argentina 1-0 after extra time in the final on July 19. Tournament complete.',
    category: 'sports',
    emoji: '🏆',
    articleSlug: '/predictions/world-cup-2026-winner',
    lastUpdated: '2026-07-19T22:00:00Z',
    featuredMarketId: 'wc2026-spain',
...
// =============================================================================
// WORLD CUP 2026 — Full tournament tracker (FINAL — Spain champions)
// Updated: July 19, 2026 — Spain 1-0 Argentina (AET) in the final. Tournament complete.
// =============================================================================
...
const worldCupFullMarkets: PredictionMarket[] = [
  ...
  },
  {
    ...
    platformUrl: 'https://polymarket.com/event/2026-fifa-world-cup-winner',
    status: 'resolved',
    closingDate: '2026-07-01T22:00:00Z',
    lastUpdated: '2026-07-01T22:00:00Z',
    change24h: 0,
    volume: '$780K',
    resolvedOutcome: 'lost',
  },
...
export const WORLD_CUP_2026_TOPIC: PredictionTopic = {
  id: 'world-cup-2026',
  title: 'World Cup 2026 Winner | Spain Champions',
  description: 'Spain won the 2026 FIFA World Cup, defeating Argentina 1-0 after extra time in the final at MetLife Stadium on July 19. Ferran Torres scored the winner in the 106th minute. Tournament complete.',
  category: 'sports',
  emoji: '🏆',
  articleSlug: '/predict/world-cup/2026',
  lastUpdated: '2026-07-19T22:00:00Z',
  featuredMarketId: 'wc26-spain',
